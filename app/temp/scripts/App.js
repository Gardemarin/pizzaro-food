...
/***/ (function(module, exports, __webpack_require__) {
	...
	var verticalSlider = new _Slider2.default(verticalSliderData);

	var horizontalSliderData = {
	...
	var horizontalSlider = new _Slider2.default(horizontalSliderData);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MobileMenu = function () {
	  function MobileMenu() {
	    ...
	    this.siteHeaderMenu = (0, _jquery2.default)(".site-header__menu");
	    this.fullList = (0, _jquery2.default)(".order__full");
	    ...
	    this.menu = (0, _jquery2.default)('.side-menu__nav');
	  ...
	  _createClass(MobileMenu, [{
	    key: 'over',
	    value: function over(current, data) {
	      (0, _jquery2.default)(data.options.items).removeClass('active');
	      (0, _jquery2.default)(current).addClass('active');
	    }
	  }, {
	    key: 'leave',
	    value: function leave(current, data) {
	      (0, _jquery2.default)(data.options.items).removeClass('active');
	      (0, _jquery2.default)(data.itemActive).addClass('active');
	    }
	  }, {
	    key: 'events',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  window.SlidingMenu = function () {
	    ...
	    SlidingMenu.prototype.createSliding = function () {
	      ...
	      var extra = this.options.slidingClass == 'sliding-underline' ? '<div class="sliding-underline__inner"></div>' : '<span class="icon__arrow icon__arrow--right"></span><div class="triangle"><div class="triangle__body"></div></div>';
	      this.sliding = (0, _jquery2.default)('<div class="menu-sliding ' + this.options.slidingClass + '">' + extra + '</div>');
	    ...
	    SlidingMenu.prototype.setActiveState = function () {
	      this.options.items.each(function (_this) {
	        return function (index, value) {
	          if ((0, _jquery2.default)(value).hasClass(_this.options.itemActiveClass)) {
	            return _this.itemActive = (0, _jquery2.default)(value);
	          }
	        };
	      }(this));
	    ...
	    SlidingMenu.prototype.setMouseOver = function () {
	      return this.options.items.on('mouseover', function (_this) {
	        return function (event) {
	          ...
	          $self = (0, _jquery2.default)(event.target);
	          if (!_this.itemActive) {
	...
	}).call(undefined); // Generated by CoffeeScript 1.10.0
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Slider = function () {
	  function Slider(initialParams) {
	    _classCallCheck(this, Slider);

	    this.tl = new _TweenMax.TimelineMax();
	    ...
	    this.links = (0, _jquery2.default)(this.linksClass);
	    this.slider = (0, _jquery2.default)(this.sliderClass);

	    this.events();
	    (0, _jquery2.default)(this.linksClass + this.activeLinkClass).trigger('slide');
	  }
	  ...
	  _createClass(Slider, [{
	    ...
	    value: function events() {
	      ...
	      this.links.hover(this.slideTo.bind(this), function () {
	        _this.delayReturnToActiveBtn = setTimeout(function () {
	          (0, _jquery2.default)(_this.linksClass + _this.activeLinkClass).trigger('slide');
	        }, 300);
	      });
	    ...
	    value: function slideTo(event) {
	      ...
	      if (!_jquery2.default.contains(event.currentTarget, this.box) || this.flagFirstLoad) {
	        ...
	        if (this.orientation == 'vertical') {
	          ...
	          this.tl.from(this.box, 1, {
	            ...
	            y: rect.top - newRect.top,
	            ease: _TweenMax.Power3.easeOut
	          }).fromTo(this.box, 1, { width: this.slider.width() }, { width: (0, _jquery2.default)(event.currentTarget).width() }, 0).to(this.boxInner, 1, {
	            width: (0, _jquery2.default)(event.currentTarget).width() / 2,
	            ease: _TweenMax.Power3.easeOut
	          }, 0);
	        }
	      }
	    ...
	    key: 'addLightClass',
	    value: function addLightClass(tween, slider, parent) {
	      slider.links.removeClass('light');
	      if (Math.abs(tween.target._gsTransform.y) < 40) {
	        (0, _jquery2.default)(parent).addClass('light');
	      }
	    }
	  }]);
